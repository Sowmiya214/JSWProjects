...
function batchListByYard(bay_id, r1) {
	$.ajax({
		...
		url: base_url+"/batchInfo/getBatchAllListByYardHTML?bay_id=" + bay_id + "&row_no=" + r1 + "&option=1",
		type: "GET",
		/*data: JSON.stringify(formData),
		//dataType: "JSON",*/
	...
	$.ajax({
		...
		url: base_url+"/batchInfo/getBatchAllListByYardHTML?bay_id=" + bay_id + "&row_no=" + r2 + "&option=3",
		type: "GET",
		/*data: JSON.stringify(formData),
		//dataType: "JSON",*/

		success: function(data) {
			$('#coilGrid3').html(data.data);
...
$(document).on("click", ".select-row", function(e) {
	...
	$("#selected_row_no2").val(r2);
	$("#lable_row_info").text(r1);
	$("#lable_row_info2").text(r2);
...
$(document).on("click", ".dot", function(e) {
	...
	if (batch_name === 'NIL') {
		...
		$.ajax({
			...
			url: base_url+"/batchInfo/getValidateForBatchPick?batch_name=" + batch_name,
			type: "GET",
			//data: JSON.stringify(formData),
			//dataType: "JSON",
...
var focusInName = '';
$(document).on("click", ".dot2", function(e) {
	...
	$('#saveOrUpdateBatch').click(function() {
		...
		$.ajax({
			...
			url: base_url+"/batchInfo/saveOrMoveBatch",
			type: "POST",
			data: JSON.stringify(formData),
			dataType: "JSON",
			...
			success: function(data) {
				if (data.status == 1) {
					...
					getRowList(bay_id);
					batchListByYard(bay_id, first_row);
	...
	$('#batch_dispatch').click(function() {
		...
		$.ajax({
			...
			url: base_url+"/batchInfo/batchDispatch?batch_name=" + dispatch_batch,
			type: "GET",
			//data: JSON.stringify(formData),
			//dataType: "JSON",
